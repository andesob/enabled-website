...
class PrivacyPolicy extends Component {
    render() {
        return (
            <div>
                <div className={"privacyPolicyPageDiv"}>
                    <h1>PRIVACY NOTICE</h1>
                    <p>Thank you for choosing to be part of our community at NTNU CPS Lab ("Company", "we", "us",
                        "our"). We
                        ...
                        information, please contact us at eegcpslab@gmail.com.


                        When you use our mobile application, as the case may be (the "App") and more generally, use any
                        of
                        our services (the "Services", which include the App), we appreciate that you are trusting us
                        with
                        your personal information. We take your privacy very seriously. In this privacy notice, we seek
                        to
                        ...
                        described
                        above, includes our App), as well as, any related services, sales, marketing or events.
                    ...
                    <p><b>Please read this privacy notice carefully as it will help you understand what we do with the
                        information that we collect.</b></p>
                    ...
                    <p>We do not collect any information at all.</p>
                    ...
                    <p>
                        ...
                        services, to protect your rights, or to fulfill business obligations.<br/><br/>

                        We may process or share your data that we hold based on the following legal basis:<br/>
                        <ul>
                            <li><b>Consent:</b> We may process your data if you have given us specific consent to use
                                your personal information for a specific purpose.
                            </li>
                            <li><b>Legitimate Interests:</b> We may process your data when it is reasonably necessary to
                            ...
                            <li><b>Legal Obligations:</b> We may disclose your information where we are legally required
                            ...
                            <li><b>Vital Interests:</b> We may disclose your information where we believe it is
                        ...
                        <ul>
                            <li><b>Business Transfer:</b> We may share or transfer your information in connection with, or
                    ...
                    <h1>3. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</h1>
                    <p>
                        In Short: We may transfer, store, and process your information in countries other than your own.<br/><br/>

                        Our servers are located in. If you are accessing our App from outside, please be aware that your
                        information may be transferred to, stored, and processed by us in our facilities and by those
                        third
                        parties with whom we may share your personal information (see "WILL YOUR INFORMATION BE SHARED
                        WITH
                    ...
                    <p>
                        ...
                        this
                        privacy notice unless otherwise required by law.<br/><br/>
                    ...
                    <p>
                        ...
                        technical security measures.<br/><br/>
                        ...
                        protect your personal information, transmission of personal information to and from our App is
                        at
                    ...
                    <h1>8. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h1>
                    <p>
                        ...
                        App,
                        you have the right to request removal of unwanted data that you publicly post on the App. To
                        request
                        ...
                        will make sure the data is not publicly displayed on the App, but please be aware that the data
                        may
                    ...
                    <p>
                        If you have questions or comments about this notice, you may email us at eegcpslab@gmail.com.<br/><br/>

                        NTNU CPS Lab<br/>
                        Larsgårdsvegen 2<br/>
                        Ålesund, Ålesund 6009<br/>
                        Norway
                    </p>
                </div>
            </div>
